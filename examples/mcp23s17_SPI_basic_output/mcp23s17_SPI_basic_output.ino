...
typedef MCP23S17_WE MCP; // just for less typing!
...
MCP myMCP = MCP(CS_PIN, RESET_PIN, MCP_ADDRESS); // short version
// MCP23S17_WE myMCP = MCP23S17_WE(CS_PIN, RESET_PIN, MCP_ADDRESS); // long version
