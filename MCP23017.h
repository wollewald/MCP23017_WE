...
class MCP23017{
	public:
		...
		void Init();
		void reset(); 
		void setPinMode(byte, PORT, STATE); 
		void setPortMode(byte, PORT); 
		void setPin(byte, PORT, STATE); 
		void togglePin(byte, PORT); 
		void setPinX(byte, PORT, byte, STATE); 
		void setAllPins(PORT, STATE); 
		void setPort(byte, PORT);    
		void setPort(byte, byte, PORT, PORT); 
		void setPortX(byte, byte, PORT); 
		void setInterruptPinPol(STATE); 
		void setIntOdr(STATE);  
		void setInterruptOnChangePin(byte, PORT); 
		void setInterruptOnDefValDevPin(byte, PORT, STATE);  
		...
		void setPinPullUp(byte, PORT, STATE); 
